 ...
 *
 * @file
 * @brief       Example application using Posix sockets 
 *
...
static const shell_command_t shell_commands[] = {
    { "tcpc", "Start a TLS client", tcp_client },
    { "tcps", "Start and stop a TLS server", tcp_server },
...
int main(void)
{
    ...
    puts("RIOT TCP testing implementation");
